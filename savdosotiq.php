...
$adminuser = "DASTURCHI_YIGIT"; // admin user
...
[['callback_data' => "KARMANA", 'text' => "KARMANA"],['callback_data' => "QIZIL TEPA", 'text' => "QIZIL TEPA"],],
...
[['callback_data' => "KONIMIX", 'text' => "KONIMIX"],['callback_data' => "OQTOSH", 'text' => "OQTOSH"],],
[['callback_data' => "NAVOIY SH", 'text' => "NAVOIY SH"],['callback_data' => "KATTA QO'RG'ON", 'text' => "KATTA QO'RG'ON"],],
[['callback_data' => "MANZILNI YASHIRISHdilar", 'text' => "MANZILNI YASHIRISH"],],
]
]);
...
'chat_id'=>$cbid,
'text'=>"✅ Сизнинг эълонингиз Админлариимиз томонидан кўриб чиқилади ва сизга мурожаат қилишади!
ILTIMOS bizning kanalni tanishlarizga tafsiya eting",
'parse_mode'=>'html',
'reply_markup'=>$keys,
]);
del($cbid);
